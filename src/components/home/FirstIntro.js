        ...
        return (
            <div className='position-relative pt-5'>
                ...
                <div className='mt-5'> 
                    ...
                    <p className='text-right artx-gradient-text artx-type-sf mb-3'><img className='align-middle mr-3' src={upcaret} alt='' aria-hidden='true'/>{this.props.currentPrice}<img className='align-baseline ml-3' src={eth} alt='ethereum icon'/></p>
                </div>
            </div>
        );
    }
